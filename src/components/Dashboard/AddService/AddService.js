...
const AddService = () => {
    ...
    const handleSubmit = (e) =>{
        ...
        fetch('https://shrouded-bastion-35026.herokuapp.com/addService', {
            method: 'POST',
            body: formData
        })
        ...
        <section className="fluid-container ">
            ...
            <div className="row">
                ...
                <div className="col-md-10 p-4 mx-auto">
                    <h1 className="border-bottom mb-2 text-brand">Add Service</h1>
                    ...
                    <form class="row  bg-secondary shadow mt-5 p-5 rounded container shadow" onSubmit={handleSubmit}>
                        <div className="col-md-6">
                            ...
                            <input type="text" name="title" onBlur={handleBlur} class="form-control" placeholder="Enter service Title" />
                        </div>
                        <div className="col-md-6">
